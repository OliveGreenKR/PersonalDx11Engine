#include "CollisionDetectionSubSystem.h"
#include <algorithm>



FCollisionDetectionResult FCollisionDetection::DetectCollisionDiscrete(
...
FCollisionDetectionResult FCollisionDetection::DetectCollisionCCD(
	const FCollisionShapeData& ShapeA,
...
FCollisionDetectionResult FCollisionDetection::SphereSphere(
...
FCollisionDetectionResult FCollisionDetection::BoxBoxAABB(
...
FCollisionDetectionResult FCollisionDetection::BoxBoxSAT(
	const Vector3& ExtentA, const FTransform& TransformA,
	const Vector3& ExtentB, const FTransform& TransformB)
{
	FCollisionDetectionResult Result;
...
FCollisionDetectionResult FCollisionDetection::BoxSphereSimple(
