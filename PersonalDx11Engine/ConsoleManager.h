...
public:
	// std::cout 호환성을 위한 메서드
	void EnableStandardOutputRedirection();
	void DisableStandardOutputRedirection();
	bool IsStandardOutputRedirected() const { return bStdoutRedirected; }
