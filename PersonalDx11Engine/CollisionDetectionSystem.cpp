...
FCollisionDetectionResult UCollisionDetectionSystem::SphereSphere(
...
FCollisionDetectionResult UCollisionDetectionSystem::BoxBoxAABB(
...
FCollisionDetectionResult UCollisionDetectionSystem::BoxBoxSAT(
	const Vector3& ExtentA, const FTransform& TransformA,
	const Vector3& ExtentB, const FTransform& TransformB)
{
	FCollisionDetectionResult Result;
...
FCollisionDetectionResult UCollisionDetectionSystem::BoxSphereSimple(
