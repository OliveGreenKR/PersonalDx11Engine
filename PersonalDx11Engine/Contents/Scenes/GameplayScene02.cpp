...
void UGameplayScene02::Initialize()
{
    ...
    Colli.lock()->OnCollisionEnterDelegate.BindSystem([](const FCollisionEvent& InEvent) {
        LOG("CollisionEnter"); }, "OnCollisionEnter_P1");
    Colli.lock()->OnCollisionStayDelegate.BindSystem([](const FCollisionEvent& InEvent) {
        LOG("CollisionStay"); }, "OnCollisionEnter_P1");
    Colli.lock()->OnCollisionExitDelegate.BindSystem([](const FCollisionEvent& InEvent) {
