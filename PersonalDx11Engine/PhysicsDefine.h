...
struct FGameToPhysicsData {
    ...
    FGameToPhysicsData() = default;

    explicit FGameToPhysicsData(const FTransform& transform,
                                EPhysicsType type = EPhysicsType::Dynamic,
                                FPhysicsMask mask = FPhysicsMask(FPhysicsMask::GROUP_BASIC_SIMULATION))
